...
public class MessagePage {
	...
	private void initElements() {
		System.out.println("le MessagePage start");
	//	msgTitle=driver.findElement(By.xpath("/html[1]/body[1]/header[1]/div[1]/div[2]"));
		...
		System.out.println("le MessagePage end");
	}
	// emailTo field
	...
	public MessagePage setSubject(String subject) {
		clickSubject();
	    clearSubject();
	...
	public MessagePage setBody(String body) {
		clickBody();
		clearBody();
